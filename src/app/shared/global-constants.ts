export class GlobalConstants {
  ...
  public static readonly API_URL_UPLOADS_NEWS =
    'http://localhost:3000/api/uploads/news'
  public static readonly API_URL_UPLOADS_MEMBERS =
    'http://localhost:3000/api/uploads/members'
  public static readonly API_URL_UPLOADS_CONTACT =
    'http://localhost:3000/api/uploads/contact'
  public static readonly API_URL_UPLOADS_ADMIN =
    'http://localhost:3000/api/uploads/admin'
  public static readonly API_URL_UPLOADS_LOGO =
    'http://localhost:3000/api/uploads/logo'
  public static readonly API_URL_UPLOADS_FAVICON =
    'http://localhost:3000/api/uploads/favicon'
  public static readonly API_URL_UPLOADS_SLIDER =
    'http://localhost:3000/api/uploads/slider'
